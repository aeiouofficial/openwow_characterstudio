...
assert.equal(build.version,'4.1.0');
const required=[
  'Machinima Studio Elite','CS_V41_VERSION','character-studio_v4.1.0',
...
for(const token of required) assert.ok(html.includes(token),`Missing v4.1.0 surface: ${token}`);
